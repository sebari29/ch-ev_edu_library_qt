...
#define MAX_INITIAL_LINE_FINE_X		(MAX_TOUCH_LIMIT_FINE) //0~255
...
#define FINE_LOOP_SHADOW_ST     (FINE_LOOP_XY_ED+1) //3
#define FINE_LOOP_SHADOW_ED     (FINE_LOOP_SHADOW_ST+2) //5
#define FINE_LOOP_EDGE_X        (FINE_LOOP_SHADOW_ED+1) //6
#define FINE_LOOP_BRUSH         (FINE_LOOP_EDGE_X+1)    //7
#endif
...
extern initial_line_a_t BS_initial_line_a_y[MAX_INITIAL_LINE_FINE_Y];
