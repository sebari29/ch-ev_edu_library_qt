...
extern float s_aarea_zero_y, s_aarea_end_y;
extern float s_logical_max_x, s_logical_max_y;
extern float s_pd_pos_x[MAX_SENSOR_POS_SIZE];
extern float s_pd_pos_y[MAX_SENSOR_POS_SIZE];
extern float s_led_pos_x[MAX_SENSOR_POS_SIZE];
extern float s_led_pos_y[MAX_SENSOR_POS_SIZE];
extern DEF_PD_INFO *s_inBuf;
extern DEF_TOUCH_OUT s_outBuf[ALLOWABLE_TOUCH_IO];
...
#define A0_OUT_FINE					0.4f //0.35f //0.45f //0.5f
...
#define START_FRAME_LIMIT			10	//4  //750 PV	//3	//4 R0004 YJ200428
...
#define MAX_SIZE_PEN_2          10.0f				//  < w_max  2
#define MAX_SIZE_PEN_2_EDGE     11.0f	//8.0f
#define MAX_SIZE_PEN_2_SIDE     8.0f
#define MAX_SIZE_MARKER_1       8.0f				//  > w_min  4
#define MAX_SIZE_MARKER_1_EDGE  11.0f	//8.0f
#define MAX_SIZE_MARKER_1_SIDE  8.0f
#define MAX_SIZE_MARKER_2       14.0f				//  > w_max  31
#define MAX_SIZE_MARKER_2_EDGE  12.0f
#define MAX_SIZE_MARKER_2_SIDE  12.0f
#define MAX_SIZE_ERASER_1       80.0f
#define MAX_SIZE_ERASER_1_EDGE  60.0f
#define MAX_SIZE_ERASER_1_SIDE  60.0f

#else  //KYJ20200228
#define MAX_SIZE_PEN_1          5.0f				//  < w_min  1
#define MAX_SIZE_PEN_1_EDGE     4.0f
#define MAX_SIZE_PEN_1_SIDE     4.0f
#if 0 //KYJ20200529 for Test
#define MAX_SIZE_PEN_2          12.0f	//8.0f	//10.0f	//8.0f R0004	//7.5f					//  < w_max  2
#define MAX_SIZE_MARKER_1       13.0f 	//10.0f//11.0f	//8.0f R0004	//7.5f					//  > w_min  4
#define MAX_SIZE_MARKER_2       16.0f	//14.0f R0004				//  > w_max  31

#define MAX_SIZE_PEN_2_EDGE     12.0f	//14.0f	//16.0f	//17.0f	//11.0f R0004
#define MAX_SIZE_MARKER_1_EDGE  13.0f	//17.0f	//18.0f	//11.0f	R0004
#define MAX_SIZE_MARKER_2_EDGE  20.0f	//12.0f R0004

#define MAX_SIZE_PEN_2_SIDE     8.0f   //8.0f	//9.0f	//10.0f	//8.0f R0004
#define MAX_SIZE_MARKER_1_SIDE  9.0f	//11.0f	//8.0f R0004
...
#if 0
#define MAX_SIZE_PEN_1          3.0f				//  < w_min  1
#define MAX_SIZE_PEN_1_EDGE     3.0f
#define MAX_SIZE_PEN_1_SIDE     3.0f
#define MAX_SIZE_PEN_2          5.0f	//7			//  < w_max  2
#define MAX_SIZE_PEN_2_EDGE     5.0f	//8.0f
#define MAX_SIZE_PEN_2_SIDE     5.0f
#define MAX_SIZE_MARKER_1       7.5f				//  > w_min  4
#define MAX_SIZE_MARKER_1_EDGE  7.5f	//8.0f
#define MAX_SIZE_MARKER_1_SIDE  5.0f
#define MAX_SIZE_MARKER_2       14.0f				//  > w_max  31
#define MAX_SIZE_MARKER_2_EDGE  12.0f
#define MAX_SIZE_MARKER_2_SIDE  12.0f
#define MAX_SIZE_ERASER_1       80.0f
...
#endif
#endif //0
#if 0 //reserved, for ise-demo
#define MAX_SIZE_PEN_MARKER     8.0f
#define MIN_SIZE2_MARKER_CENTER 12.0f
#define MIN_SIZE2_MARKER_EDGE   9.0f
#endif //0
...
extern void s_smooth_filter_test(void);
#endif
    /* Provide C++ Compatibility */
#ifdef __cplusplus
}
